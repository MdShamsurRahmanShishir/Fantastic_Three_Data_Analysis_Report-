...
Dataset Files (CSV) – Google Drive:
https://drive.google.com/drive/folders/1Rxumqox-KJGJs1wtYagzfptogJTjaMqY?usp=sharing

The dataset contains time-stamped IoT sensor readings collected from multiple devices, including:
...
Statistical theory validation (LLN & CLT)
